...
const CreatorCard = ({ rank, creatorName, creatorImg, creatorEth }) => (
  <div className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-gray-50 border dark:border-nft-black-3 border-white rounded-3xl flex flex-col p-4 m-4">
    ...
    <div className="mt-3 minlg:mt-7 text-center flexCenter flex-col">
      ...
      <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-base mt-1">{creatorEth.toFixed(2)} <span className="font-normal">ETH</span> </p>
    </div>
  </div>
);
